...
<body>
	...
	<div class="container">
		<div class="row">
			<table>
				...
				<tbody>
					...
					<tr class="writing_date">
						...
						%>
						<td><a href="fileDownload.jsp?fileName=<%=board.getUploadFile()%>" id="fileDown"><%= board.getUploadFile() %></a></td>
						<% 
							}
						%>
					</tr>
			...
			<div class="btn">
				<a href="index.jsp"><button class="list_btn">목록</button></a>
			<% 
				if(userID != null && userID.equals(board.getUserID())){
			%>
				<a href="update.jsp?idx=<%= board_idx %>" onclick="return confirm('수정 하시겠습니까?')"><button class="update_btn">수정</button></a>
				<a href="deleteAction.jsp?idx=<%= board_idx %>" onclick="return confirm('정말 삭제하시겠습니까?')"><button class="delete_btn">삭제</button></a>
			<%		
				}
			%>
		   </div>
